      ...
      if (http.readyState === 4 && http.status === 200) {
        ...
        if (response.Items.length === 1 && typeof (response.Items[0].Error) != "undefined") {
          ...
          if (response.Items.length === 0)
            ...
            console.log(res)
            document.getElementById("country").value = res.CountryIso2;
            document.getElementById("state").value = res.Province;
            document.getElementById("city").value = res.City;
            document.getElementById("postcode").value = res.PostalCode;
            document.getElementById("autocomplete").value = res.Line1;
                              ...
                              <div className="row">
                                ...
                                <div className="col-lg-6 col-md-6">
                                  <div className="billing-info mb-20">
                                    ...
                                    <Controller
                                      ...
                                      render={props => {
                                        return (
                                          <select id="country" onChange={(e) => { props.onChange(e.target.value); }} value={props.value}>
                                ...
                                <div className="col-lg-6 col-md-6">
                                  <div className="billing-info mb-20">
                                    ...
                                    <input id="state" type="text" name={billingForm.stateProvince.name} ref={billingRef(billingForm.stateProvince.validate)} />
                                ...
                                <div className="col-lg-6 col-md-6">
                                  <div className="billing-info mb-20">
                                    ...
                                    <input id="city" type="text" name={billingForm.city.name} ref={billingRef(billingForm.city.validate)} />
                                ...
                                <div className="col-lg-6 col-md-6">
                                  <div className="billing-info mb-20">
                                    ...
                                    <input id="postcode" type="text" name={billingForm.postalCode.name} ref={billingRef(billingForm.postalCode.validate)} />
                            ...
                            <form onSubmit={deliverySubmit(onUpdateDelivery)}>
                              <div className="row">
                                ...
                                <div className="col-lg-12">
                                  <div className="billing-info mb-20">
                                    <label>{strings["Company Name"]}</label>
                                    <input id="company" type="text" name={billingForm.shipCompany.name} ref={deliveryRef(billingForm.shipCompany.validate)} />
                                  </div>
                                </div>
                                <div className="col-lg-12">
                                  <div className="billing-info mb-20">
                                  ...
                                  <div className="billing-info mb-20">
                                    <label>{strings["State"]}</label>
                                    {
                                      shipStateData && shipStateData.length > 0 ?
                                        ...
                                        />
                                        :
                                        <input id="state" type="text" name={billingForm.shipStateProvince.name} ref={deliveryRef(billingForm.shipStateProvince.validate)} />
                                    }
                                ...
                                <div className="col-lg-6 col-md-6">
                                  <div className="billing-info mb-20">
                                    <label>{strings["Town/City"]}</label>
                                    <input id="city" type="text" name={billingForm.shipCity.name} ref={deliveryRef(billingForm.shipCity.validate)} />
                                ...
                                <div className="col-lg-6 col-md-6">
                                  <div className="billing-info mb-20">
                                    <label>{strings["Postcode"]}</label>
                                    <input id="postcode" type="text" name={billingForm.shipPostalCode.name} ref={deliveryRef(billingForm.shipPostalCode.validate)} />
